    ...
    <div className="headerDiv">
      ...
      <div className=" lDiv">
        ...
        <p className="describing">
          Web and applications developer with a year and a half of experience,
          <br /> proficient in working databases.
        </p>
        <button className="hireMeBtn">
          Hire Me <IoIosArrowDroprightCircle className="arrowIcon" />
        </button>
      </div>
      {/* <img className="ballDown" src="/Ball-0.7s-200px.gif" alt="" /> */}
    </div>
  );
};
